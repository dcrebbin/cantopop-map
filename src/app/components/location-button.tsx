...
export default function LocationButton() {
  ...
  return (
    <div className="absolute bottom-0 right-0 z-[90] m-0 mb-4 flex flex-row items-center gap-4 p-8">
      <button
        type="button"
        className="z-[100] cursor-pointer transition-transform duration-300 hover:scale-110 md:hidden"
        onClick={() => {
