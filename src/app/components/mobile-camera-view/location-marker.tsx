...
export function LocationMarker({
  ...
  return (
    <div
      className="absolute flex h-28 w-48 flex-col items-center overflow-hidden rounded-xl border border-white/40 bg-black/50 text-center text-white backdrop-blur-lg"
      style={{
        left: `clamp(6rem, ${entry.horizontalPercent}%, calc(100% - 6rem))`,
        top: `clamp(3.5rem, ${entry.verticalPercent}%, calc(100% - 3.5rem))`,
